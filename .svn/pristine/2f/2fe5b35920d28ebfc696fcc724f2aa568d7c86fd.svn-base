...
public class GunDude extends Player {
	...
	public GunDude(Color col){
		super(500, col);
		loadAnims();
	}
	
	public GunDude(int x, int y, Color col) {
		this(col);
		playerX = x;
		playerY = y;
	}
